      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage>{t("ui.label.users")}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          <DialogTitle>{t("ui.label.user")}</DialogTitle>
        ...
        <>
          ...
          <div>
            <strong className="pr-1">{t("ui.label.email")}:</strong>
            {selectedItem?.email}
          </div>
          <div>
            <strong className="pr-1">{t("ui.label.phone")}:</strong>
            {selectedItem?.phone}
          </div>
          <div>
            <strong className="pr-1">{t("ui.label.office")}:</strong>
            {selectedItem?.office?.shortName}
          </div>
          <div>
            <strong className="pr-1">{t("ui.label.department")}:</strong>
