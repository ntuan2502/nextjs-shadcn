...
export default function DeviceModelsComponent() {
      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage>{t("ui.label.deviceModels")}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex justify-between items-center text-2xl font-bold">
              <p>{t("ui.label.deviceModels")}</p>
              <Button>
                <Link href={ROUTES.DEVICE_MODEL_ADD}>{t("ui.button.add")}</Link>
              </Button>
            </CardTitle>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-56" align="start">
                              <DropdownMenuGroup>
                                ...
                                <Link href={ROUTES.DEVICE_MODEL_EDIT(item.id)}>
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          <DialogTitle>{t("ui.label.deviceModel")}</DialogTitle>
