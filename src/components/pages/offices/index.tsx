      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage>{t("ui.label.offices")}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex justify-between items-center text-2xl font-bold">
              <p>{t("ui.label.offices")}</p>
              <Button>
                <Link href={ROUTES.OFFICE_ADD}>{t("ui.button.add")}</Link>
              </Button>
            </CardTitle>
            <SearchComponent
              t={t}
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>
                      <p className="text-wrap">{t("ui.label.shortName")}</p>
                    </TableHead>
                    <TableHead>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-56" align="start">
                              <DropdownMenuGroup>
                                ...
                                <Link href={ROUTES.OFFICE_EDIT(item.id)}>
